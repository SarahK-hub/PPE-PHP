...
<body>
    <div class="topbar">
       ...
       <a class="button" href="<?= BASE_URL ?>etat/create">Inserer</a>
...
<?php foreach ($etats as $etat): ?>
    <tr>
        ...
        <td>
           <a class="button" href="<?= BASE_URL ?>etat/<?= $etat['id'] ?>">Voir</a>
           <a class="button" href="<?= BASE_URL ?>etat/<?= $etat['id'] ?>/update">Modifier</a>


           <form method="post"
                  action="<?= BASE_URL ?>etat/<?= (int)$etat['id'] ?>/delete"
